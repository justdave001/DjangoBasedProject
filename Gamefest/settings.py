"""
Django settings for Gamefest project.
...
SECRET_KEY = 'ka&9w&wwhr1)^fw(yar-c$ub_hr5fig&ufn96*o#zkk&zj(n5!'
...
WSGI_APPLICATION = 'Gamefest.wsgi.application'
